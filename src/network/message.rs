...
mod test {
    ...
    fn serialize_verack_test() {
        assert_eq!(serialize(&RawNetworkMessage { magic: 0xd2b9baf6, payload: NetworkMessage::Verack }),
                             vec![0xf9, 0xba, 0xb9, 0xd2, 0x76, 0x65, 0x72, 0x61,
    ...
    fn serialize_ping_test() {
        assert_eq!(serialize(&RawNetworkMessage { magic: 0xd2b9baf6, payload: NetworkMessage::Ping(100) }),
                             vec![0xf9, 0xba, 0xb9, 0xd2, 0x70, 0x69, 0x6e, 0x67,
    ...
    fn serialize_mempool_test() {
        assert_eq!(serialize(&RawNetworkMessage { magic: 0xd2b9baf6, payload: NetworkMessage::MemPool }),
                             vec![0xf9, 0xba, 0xb9, 0xd2, 0x6d, 0x65, 0x6d, 0x70,
    ...
    fn serialize_getaddr_test() {
        assert_eq!(serialize(&RawNetworkMessage { magic: 0xd2b9baf6, payload: NetworkMessage::GetAddr }),
                             vec![0xf9, 0xba, 0xb9, 0xd2, 0x67, 0x65, 0x74, 0x61,
    ...
    fn deserialize_getaddr_test() {
        let msg = deserialize(
            &[0xf9, 0xba, 0xb9, 0xd2, 0x67, 0x65, 0x74, 0x61,
                0x64, 0x64, 0x72, 0x00, 0x00, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x5d, 0xf6, 0xe0, 0xe2]);
        let preimage = RawNetworkMessage { magic: 0xd2b9baf6, payload: NetworkMessage::GetAddr };
        assert!(msg.is_ok());
    ...
    fn deserialize_version_test() {
        ...
        assert!(msg.is_ok());
        let msg = msg.unwrap();
        assert_eq!(msg.magic, 0xd2b9baf6);
    ...
    fn deserialize_partial_message_test() {
        let data = [  0xf9, 0xba, 0xb9, 0xd2, 0x76, 0x65, 0x72, 0x73,
            0x69, 0x6f, 0x6e, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x66, 0x00, 0x00, 0x00, 0xbe, 0x61, 0xb8, 0x27,
            0x7f, 0x11, 0x01, 0x00, 0x0d, 0x04, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0xf0, 0x0f, 0x4d, 0x5c,
